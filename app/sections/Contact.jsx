...
const Contact = () => {
    ...
    return (
        <section className='min-h-screen w-full bg-[#0a0a0a] font-mono relative overflow-hidden flex flex-col p-6'>
            ...
            <motion.div
                className='fixed top-6 left-6 text-[#c4ff00] text-2xl font-bold z-50'
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <motion.div
                className='fixed top-6 right-6 bg-[#c4ff00] px-4 py-2 text-black text-[10px] font-bold tracking-widest z-50'
            ...
            <main className='min-h-screen w-[90%] self-end relative z-10'>
                ...
                {/* Form Container */}
                <motion.div
                    className='w-[75%] h-[75vh] ml-[10%] flex justify-between items-center mt-12'
                ...
                >
                    ...
                    <motion.form
                        ...
                        className='w-[65%] h-[80%] bg-transparent border-2 border-[#c4ff00]/30 p-8 relative overflow-hidden'
                            ...
                            {isSubmitted && (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className='text-sm text-black/70 tracking-wider'>
                        ...
                        <div className='relative z-10 h-full flex flex-col justify-between'>
                            ...
                            <div className='mb-6'>
                                <div className='flex justify-between items-center mb-4'>
                                    ...
                                    <p className='text-[10px] text-[#c4ff00] tracking-widest'>
                                        SECURE_PATH
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='space-y-6 flex-1'>
                                ...
                                <div className='flex-1 flex flex-col'>
                                    ...
                                    <textarea
                                        ...
                                        className='flex-1 bg-transparent border-2 border-gray-800 focus:border-[#c4ff00] outline-none text-white p-4 resize-none transition-colors duration-300'
                            ...
                            {/* Form Footer */}
                            <div className='mt-6 flex justify-between items-center text-[9px] text-gray-600 tracking-wider'>
                                <div className='flex gap-4'>
                    ...
                    <motion.button
                        ...
                        className='w-[30%] h-[80%] bg-[#c4ff00] text-[#0a0a0a] font-bold text-2xl shadow-[-15px_15px_0px_0px_#000] flex flex-col items-center justify-center gap-6 relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed'
                        whileHover={!isSubmitting && !isSubmitted ? {
                            scale: 1.02,
                            boxShadow: '-20px 20px 0px 0px #000, 0 0 40px rgba(196, 255, 0, 0.3)'
                        } : {}}
                        ...
                        {isSubmitting ? (
                            ...
                            <motion.div className='flex flex-col items-center gap-4'>
                                ...
                                <div className='text-center'>
                                    <p className='text-xl font-black tracking-wider'>SENDING</p>
                                    <p className='text-[10px] tracking-widest mt-2'>PROCESSING...</p>
                                </div>
                            </motion.div>
                        ) : (
                            <>
                                ...
                                >
                                    <Send className='w-16 h-16' strokeWidth={3} />
                                </motion.div>

                                {/* Text */}
                                <div className='text-center'>
                                    <p className='text-3xl font-black tracking-wider'>SEND</p>
                                    <p className='text-[10px] tracking-widest mt-2'>
                ...
                {/* Contact Info Cards */}
                <motion.div
                    className='w-[75%] ml-[10%] mt-8 flex gap-4'
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                {/* Footer info */}
                <motion.div
                    className='w-[75%] ml-[10%] mt-6 text-[9px] text-gray-600 tracking-wider flex justify-between'
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.6, delay: 1.4 }}
                >
                    <p>[PORT_80] [HTTPS_443] [SMTP_25] [FALLBACK]</p>
